            ...
            <div className="w-full mx-auhref max-w-screen-xl p-4 md:flex md:items-center md:justify-between">
                ...
                <div className="mt-4 md:mt-0 md:text-right">
                    <ul className="w-full space-x-8 md:space-x-12 items-center flex flex-wrap text-center md:text-right">
                        <li className="pb-3">
                            <Link href='/' className="text-sm text-gray-700 hover:text-blue-400 font-bold dark:text-gray-400">Home</Link>
                        </li>
                        <li className="pb-3">
                            <Link href='/products' className="text-sm text-gray-700 hover:text-blue-400 font-bold dark:text-gray-400">Products</Link>
                        </li>
                        <li className="pb-3">
                            <Link href='/products/sales' className="text-sm text-[red] font-bold">News Sale</Link>
                        </li>
                        <li className="pb-3">
                            <Link href='/contacts' className="text-sm text-gray-700 hover:text-blue-400 font-bold dark:text-gray-400">Contacts</Link>
                        </li>
                    </ul>
                </div>
            </div>
